...
;; (setq highlight-symbol-idle-delay 1.5) ;; IMPORTANT to prevent VOID error
...
(defcustom highlight-symbol-colors
  '("dark slate gray" "dark slate blue" "dark green"
    "sienna" "brown" "maroon" "dark orchid" "SlateBlue3" "DeepSkyBlue4" "cyan4" "SpringGreen4")
  ;; '("cyan" "MediumPurple1" "SpringGreen1"
  ;;   "DarkOrange" "HotPink1" "RoyalBlue1" "OliveDrab" "DarkCyan")
    ...
    (if (member symbol highlight-symbol-list)
      ...
      (let ((color (nth highlight-symbol-color-index
        ...
        (setq color `((background-color . ,color)
                      (foreground-color . "gray100"))) ;; foreground
        ;; highlight
        (with-no-warnings

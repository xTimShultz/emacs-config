  ...
  (color-theme-install
   '(color-theme-midnight
     ((font . "fixed")
      ...
      (cursor-color . "grey85"))
     (default ((t (nil))))
     (font-lock-comment-face ((t (:italic t :foreground "light green"))))
...
(defun color-theme-travis-white ()
  (interactive)
  (color-theme-install
   '(color-theme-travis-white
     ...
     (mode-line ((t (:foreground "#fafaf9" :background "#4a5568"))))
     (region ((t (:background "#fff9a3"))))
     (font-lock-builtin-face ((t (:foreground "#000000"))))
     (font-lock-comment-face ((t (:foreground "#186d0d"))))
     (font-lock-function-name-face ((t (:foreground "#1034b2"))))
     (font-lock-keyword-face ((t (:foreground "#0024bd"))))
     (font-lock-string-face ((t (:foreground "#007a5b"))))
     (font-lock-type-face ((t (:foreground"#a512a4"))))
     (font-lock-variable-name-face ((t (:foreground "#a611a4"))))
     (minibuffer-prompt ((t (:foreground "#7299ff" :bold t))))
     (font-lock-warning-face ((t (:foreground "Red" :bold t))))
     )))
(provide 'color-theme-travis-white)

(defun color-theme-travis ()
  "Color theme by Travis Shultz.
...
fonts."
  ...
  (color-theme-install
   '(color-theme-midnight
     ...
     (font-lock-constant-face ((t (:foreground "OliveDrab"))))
     (font-lock-type-face ((t (:foreground "DarkCyan"))))
     (font-lock-variable-name-face ((t (:foreground "pink3"))))
     (font-lock-function-name-face ((t (:foreground "SlateBlue"))))
     (font-lock-builtin-face ((t (:foreground "SkyBlue"))))
     (highline-face ((t (:background "grey12"))))
     (setnu-line-number-face ((t (:background "Grey15" :foreground "White" :bold t))))
